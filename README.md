...
- **로그인 및 회원가입**: JWT 기반 인증 및 OAuth 소셜 로그인 기능 제공
- **북마크 기능**: 사용자가 관심 있는 학습 자료를 저장하고 관리할 수 있는 기능
- **학습 자료 공유**: URL을 통해 간편하게 학습 자료를 공유하는 기능
- **검색 기능**: 태그 및 카테고리 기반으로 학습 자료를 효율적으로 검색하는 기능
- **리뷰 및 평가**: 학습 자료에 대한 사용자 피드백 및 평점을 남길 수 있는 시스템
- **콘텐츠 관리**: CRUD(Create, Read, Update, Delete) 기능 및 자료의 버전 관리를 지원
  **태그 기능**: 학습 자료에 태그를 추가하여 분류하고 식별할 수 있는 기능
- **FAQ 기능**: 사용자 질문에 대한 답변을 제공하는 질의응답 시스템
- **신고 기능**: 부적절한 콘텐츠나 사용자를 신고하여 회원 보호를 위한 시스템
- **관리자 기능**: 플랫폼 운영을 위한 관리자 도구 및 사용자 관리 기능
